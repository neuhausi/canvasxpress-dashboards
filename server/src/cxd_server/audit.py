...
_ACTIONS = {
    ...
    ("POST", "/api/dashboards/{dashboard_id}/sign"): "dashboard.sign",
    ("POST", "/api/dashboards/{dashboard_id}/versions/{version}/restore"): "dashboard.restore",
    ("GET", "/api/dashboards/{dashboard_id}/versions/{version}"): "dashboard.version.open",
    ("GET", "/api/admin/signatures/verify"): "admin.signatures.verify",
